...
public class SecurityPermission implements Permission {
    ...
    public static final String REGRA_DESENV = "desenvs";

  public static final String REGRA_REQ = "requisitos";

  public static final String REGRA_TEST = "testadores";
  ...
  public void loadSecurityPermission(HttpSecurity http) throws Exception {
    ...
    // public
  	...
  	http.authorizeRequests().antMatchers("/views/Images/**").permitAll();
  	...
  	http.authorizeRequests().antMatchers("/views/logged/projetos/desenvolvedores.view.html").hasAuthority(REGRA_DESENV);
  	http.authorizeRequests().antMatchers("/views/logged/projetos/desenvolvedores.view.html").hasAuthority(ROLE_ADMIN_NAME);
